// 在 Vue 中，filters 与 methods、computed、watch 等有所不同，在 filters 中不能对原始的响应式数据进行更改，而只是改变其渲染的结果，并返回过滤后的文本。
// 所以，可以将一些常用的文本格式化工具函数封装成 filters。
// filters.js
/*
 * Vue Filters
 ...
 * @param {String} replacement // 想要替换成的字符串
 */
...
// 如何使用
// <template>
//   <p>{{ message | changeCase(1) }}</p>
// </template>

// <script>
// import { changeCase } from '/path/to/filter'
